...
# One-liner (Mac/Linux):
#   curl -sSL https://raw.githubusercontent.com/dev-nolant/porch/main/scripts/bootstrap.sh | bash
#
# With --no-startup:
#   curl -sSL https://raw.githubusercontent.com/dev-nolant/porch/main/scripts/bootstrap.sh | bash -s -- --no-startup
#
# For monorepo (porch as subdir): set SUBDIR=porch

set -e

GITHUB_REPO="${GITHUB_REPO:-https://github.com/dev-nolant/porch.git}"
